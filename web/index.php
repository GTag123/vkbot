 ...
 /*   case "wall_post_new":
    ...
    case 'message_new':
      ...
      elseif ( $split[0] == "!перевод" ){
        if ( $split[1] == "" ){
          $request_params['message'] = "Чтобы перевести текст с какого-то языка пишите:<br>!перевод <id языка> <текст для перевода><br>Исходный язык будет определён автоматически<br><br>ID языков:<br>1 - Русский<br>2 - Английский<br>3 - Французский<br>4 - Немецкий<br>5 - Китайский<br>6 - Татаркский<br>7 - Башкирский";
        }
        else {
          $lang = array(
          'ru', // 1
