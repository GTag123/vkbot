  ...
  switch($data->type){
    ...
    case 'message_new':
      ...
      if ( $split[0] == '!Ку' || $split[0] == '!ку' || $split[0] == '!привет' || $split[0] == '!Привет'){
        ...
        $request_params = array(
          'user_id' => "{$data->object->from_id}",
          'message'=>'Добро пожаловать! <br> Вот мои команды: <br> ;-P !привет - бот скажет тебе привет😜<br>👏!скажи <фраза/текст> - бот повторит твою фразу👏<br>😎!реши <пример> - бот вычислит пример за тебя😎<br>😃!анекдот - выводит случайный анекдот😃',
          'access_token' => '18d28ce6782d1c964c4bac21f4fd054378c65e739089d1bcae856947b32657436f5c2d06faa5179289e08',
          'v' => '5.80'
        );
      }
